...
% SIH Problem Statement 26038 | MathWorks Sponsored Prototype
    ...
    set(axBar, 'Color', 'w', 'XColor', [0.12, 0.15, 0.25], 'YColor', [0.12, 0.15, 0.25]);
    ...
    annotation(fig, 'rectangle', [0.05, 0.05, 0.90, 0.13], ...
        'FaceColor', [0.95, 0.96, 0.98], 'EdgeColor', [0.78, 0.82, 0.88], 'LineWidth', 1);

    doctorSignStr = {
        '\bf OPHTHALMOLOGIST TELEMEDICINE REVIEW & VALIDATION (Time required: under 30 seconds) \rm', ...
